            ...
            <c:forEach var="product" items="${listaProductos}">
                ...
                <div class="product-card">
                    ...
                    <div class="price-row">
                        ...
                        <div class="actions">
                            <button class="edit"
                                    onclick="location.href = 'editarProducto?id=${prod.idProducto}'">️<image src="icons/editAdmin.png" class="icon"></button>

                            <button class="delete"
                                    onclick="location.href = 'eliminarProducto?id=${prod.idProducto}'">️<image src="icons/deleteAdmin.png"</button>
                        </div>
                    </div>
                </div>
            </c:forEach>
